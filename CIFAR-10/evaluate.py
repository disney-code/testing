...
#         s = strategies[i]
model_path = "./checkpoint_1k_indices_22Nov/25_Nov_2nd_2312_unique_DeepSearch_expt3_1456pm/deepsearch_25Nov_1503pm_model_2_2312_025.h5"
best_model = keras.models.load_model(model_path)
lfp, afp = best_model.evaluate(fp_test, fp_test_labels, verbose=0)
# acc_fp[i].append(afp)

print(f"accuracy of ds 2312 ds 3rd time examples: {afp}")
