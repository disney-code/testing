...
np.savez('./RQ3_FOL_fuzz_output/20mins_fol_RQ3/FOL_Fuzz_20mins_25Nov_5000_index.npz', advs=advs, labels=labels, fols=fols, original_img_index=original_image_index)
dump(summary_of_adv_ori_img,open("RQ3_FOL_fuzz_output/20mins_fol_RQ3/summary_20mins_25Nov_5000_index.pkl","wb"))
time_take=time.time() - start_t
dump(time_take, open("RQ3_FOL_fuzz_output/20mins_fol_RQ3/time_taken_20mins_5000_index.pkl","wb"))
seeds_filter_shape=seeds_filter.shape
dump(seeds_filter_shape, open("RQ3_FOL_fuzz_output/20mins_fol_RQ3/seeds_filter_20mins.pkl","wb"))
